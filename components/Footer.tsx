      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <div className="mt-6">
              <h4 className="text-sm font-medium text-white mb-3 tracking-wide">Follow Us</h4>
              <div className="flex gap-3">
                {/* Instagram */}
                <a
                  href="#"
                  className="w-8 h-8 rounded-full bg-white/10 hover:bg-coral transition-colors flex items-center justify-center"
