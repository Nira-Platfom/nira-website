...
export default function ContactPage() {
  ...
  return (
    <div className="font-sans">
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-2 space-y-6">
              {contacts.map((c) => (
                <div key={c.label} className="flex items-start gap-4 bg-white border border-nira-border rounded-2xl p-5">
                  <div className="w-10 h-10 rounded-xl bg-coral-light flex items-center justify-center text-coral flex-shrink-0">
                    {c.icon}
                  </div>
                  <div>
                    <p className="text-xs font-medium text-slate-400 uppercase tracking-wide mb-1">{c.label}</p>
              ...
              {/* Languages */}
              <div className="bg-white border border-nira-border rounded-2xl p-5">
                <p className="text-xs font-medium text-slate-400 uppercase tracking-wide mb-3">We speak</p>
                <div className="flex gap-2">
                  <span className="text-sm font-medium px-3 py-1.5 bg-nira-bg border border-nira-border rounded-full">🇹🇿 Swahili</span>
                  <span className="text-sm font-medium px-3 py-1.5 bg-nira-bg border border-nira-border rounded-full">🇬🇧 English</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-3">
              <div className="bg-white border border-nira-border rounded-2xl p-8">
                {submitted ? (
                  <div className="py-10 text-center">
                    ...
                    <h3 className="font-serif text-2xl text-[#1E293B] mb-2">Message Sent!</h3>
                  ...
                  <>
                    <h2 className="font-serif text-2xl text-[#1E293B] mb-6">Send us a message</h2>
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full h-12 px-4 rounded-xl border border-nira-border bg-nira-bg text-sm text-[#1E293B] placeholder:text-nira-muted focus:outline-none focus:border-coral transition-colors"
                          />
                        </div>
                        <div>
                          <label className="block text-xs font-medium text-slate-500 mb-1.5 uppercase tracking-wide">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <select
                            ...
                            onChange={handleChange}
                            className="w-full h-12 px-4 rounded-xl border border-nira-border bg-nira-bg text-sm text-[#1E293B] focus:outline-none focus:border-coral transition-colors appearance-none"
                          >
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-3 rounded-xl border border-nira-border bg-nira-bg text-sm text-[#1E293B] placeholder:text-nira-muted focus:outline-none focus:border-coral transition-colors resize-none"
                        />
                      </div>
      ...
      {/* Download CTA */}
      <section className="py-14 bg-nira-dark text-center">
        <div className="max-w-xl mx-auto px-6">
          <p className="text-white font-serif text-2xl mb-3">Ready to try Nira?</p>
          <p className="text-slate-400 text-sm mb-6">Download free and set up your business in minutes.</p>
          <Link
            href="/#download"
