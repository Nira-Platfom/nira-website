...
const plans = [
  {
    ...
    highlight: false,
    features: [
      { text: '100 WhatsApp messages a month', included: true },
  ...
  },
  {
    ...
    price: 'TZS 350,000',
    period: '/year',
    desc: 'For established businesses that need more power. TZS 29,167/month, saves TZS 70,000 vs monthly billing.',
    highlight: false,
    features: [
      { text: 'Unlimited WhatsApp messages', included: true },
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes! Nira works with any WhatsApp Business number. You just need to connect it through the Meta Business Suite, and we guide you step by step.',
  },
  {
        ...
        <div className="max-w-6xl mx-auto px-6">
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
            {plans.map((plan) => (
              ...
              <div
                className={`relative rounded-2xl p-8 card-hover h-full ${plan.highlight ? 'bg-coral text-white shadow-2xl shadow-coral/25 md:-mt-4 md:mb-4' : 'border'}`}
          ...
          <FadeIn>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['M-Pesa', 'Airtel Money', 'Tigo Pesa', 'Visa', 'Mastercard'].map((method) => (
                <div
                  key={method}
                  className="px-5 py-2.5 rounded-xl text-sm font-medium border transition-transform hover:-translate-y-0.5"
                  style={{
